...
The MVP is designed for use by a single system on a single (Android) device with no user accounts, passwords, cloud synchronization, or network connectivity.
